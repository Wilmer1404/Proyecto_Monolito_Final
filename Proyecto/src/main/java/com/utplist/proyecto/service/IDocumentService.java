...
public interface IDocumentService {
    ...
    Page<InvitacionDTO> obtenerInvitacionesPorUsuario(String correoInvitado, Pageable pageable);
    ...
    Page<SuscripcionDTO> documentosSuscritos(String correoUsuario, Pageable pageable);
    DocumentResponseDTO obtenerPorIdConPermiso(Long id, org.springframework.security.core.Authentication auth);
    List<DocumentResponseDTO> obtenerDocumentosReportados();
    DocumentResponseDTO crearDocumentoConArchivo(String titulo, Boolean publico, org.springframework.web.multipart.MultipartFile archivo, String correo);
    DocumentResponseDTO editarDocumentoConArchivo(Long id, String titulo, Boolean publico, org.springframework.web.multipart.MultipartFile archivo, String correo, org.springframework.security.core.Authentication auth);
} 